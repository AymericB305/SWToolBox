...
public static class RegisterManageMembersPolicy
{
    public static AuthorizationBuilder AddManageMembersPolicy(this AuthorizationBuilder builder)
    {
        return builder.AddPolicy("ManageMembers", policy => policy.RequireAssertion(async context =>
        {
