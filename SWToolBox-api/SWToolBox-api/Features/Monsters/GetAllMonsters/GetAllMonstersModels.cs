...
public class GetAllMonstersMapper : ResponseMapper<MonsterResponse, Monster>
{
    public override MonsterResponse FromEntity(Monster monster)
    {
        MonsterResponseLeaderSkill? leaderSkill = null;

        if (monster.Leader is not null)
        {
